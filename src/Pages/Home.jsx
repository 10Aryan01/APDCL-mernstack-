...
function Home() {
  ...
  const handleothers = async () => {
    ...
    if (Issue !== "others") {
      try {
        let Dept;
        if (Issue === "Maintainence") {
          Dept = "D1";
        } else if (Issue === "Bill_Management") {
          Dept = "D2";
        } else {
          Dept = "others";
        }
      ...
      <div className="home">
        ...
        <div className="home-con" id="blur1">
          <div className="wrapper">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="2411" height="750px" viewBox="0 0 2411 592" fill="none">
          ...
          <div className="home-content">
            ...
            <div className="select3-inp-line">
              ...
              >
                <option value="Maintainence">Power Outage</option>
                <option value="Maintainence">Voltage Fluctuations</option>
                <option value="Bill_Management">Billing Discrepancies</option>
                <option value="Maintainence">Faulty Meters</option>
                <option value="Maintainence">Connection Issues</option>
                <option value="Maintainence">Streetlight Malfunction</option>
                <option value="Maintainence">Tree Interference</option>
                <option value="Maintainence">Circuit Breaker Tripping</option>
                <option value="Maintainence">Electricity Theft</option>
